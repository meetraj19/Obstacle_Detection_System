...
# Set the paths
model_path = '/home/thales1/ODSv02/pythonProject/odsv03/runs/detect/train6/weights/best.pt'
test_images_dir = '/home/thales1/ODS4kkaggle/samples'
output_dir = '/home/thales1/ODS4kkaggle/detectionTW1'
...
for filename in os.listdir(test_images_dir):
    if filename.endswith('.jpg') or filename.endswith('.png'):
        ...
        # Perform sliding window object detection
